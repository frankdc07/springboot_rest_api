...
import com.empresa.springboot.backendapirest.models.dao.IClienteDao;
import com.empresa.springboot.backendapirest.models.dao.IFacturaDao;
import com.empresa.springboot.backendapirest.models.dao.IProductoDao;
...
public class ClienteServiceImpl implements IClienteService {
	...
	@Override
	@Transactional(readOnly = true)
	public List<Producto> findProductoByNombre(String texto) {
		return productoDao.findByNombreContainingIgnoreCase(texto);
	}
}
